...
public class DeliveryHeader extends InternalAbstract implements RefreshHeader {
    ...
    public DeliveryHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        cloudDrawable.parserPaths("M63,0.1A22.6,22.4 0,0 0,42.1 14.2,17.3 17.3,0 0,0 30.9,10.2 17.3,17.3 0,0 0,13.7 25.8,8.8 8.8,0 0,0 8.7,24.2 8.8,8.8 0,0 0,0 32h99a7.9,7.9 0,0 0,0 -0.6,7.9 7.9,0 0,0 -7.9,-7.9 7.9,7.9 0,0 0,-5.8 2.6,22.6 22.4,0 0,0 0.3,-3.6A22.6,22.4 0,0 0,63 0.1Z");
        cloudDrawable.parserColors(0xffffffff);
        cloudDrawable.setGeometricHeight(DensityUtil.dp2px(20));
        PathsDrawable umbrellaDrawable = new PathsDrawable();
        umbrellaDrawable.parserPaths(
