package com.example.jh.refresh_layout.header;
...
import com.example.jh.refresh_layout.R;
import com.example.jh.refresh_layout.api.OnTwoLevelListener;
...
//    }
    ...
    public void onInitialized(@NonNull RefreshKernel kernel, int height, int maxDragHeight) {
        ...
        if (!thisView.isInEditMode() && mRefreshHeader.getSpinnerStyle() == SpinnerStyle.Translate
                && mRefreshKernel == null) {
            ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) mRefreshHeader.getView().getLayoutParams();
    ...
    public TwoLevelHeader setRefreshHeader(RefreshHeader header, int width, int height) {
        ...
        if (header != null) {
            ...
            if (header.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
                thisGroup.addView(mRefreshHeader.getView(), 0, new RelativeLayout.LayoutParams(width, height));
            } else {
