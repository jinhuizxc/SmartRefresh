package com.example.jh.refresh_layout;
...
import com.example.jh.refresh_layout.api.DefaultRefreshFooterCreator;
import com.example.jh.refresh_layout.api.DefaultRefreshHeaderCreator;
import com.example.jh.refresh_layout.api.RefreshContent;
import com.example.jh.refresh_layout.api.RefreshFooter;
import com.example.jh.refresh_layout.api.RefreshHeader;
import com.example.jh.refresh_layout.api.RefreshInternal;
import com.example.jh.refresh_layout.api.RefreshKernel;
import com.example.jh.refresh_layout.api.RefreshLayout;
import com.example.jh.refresh_layout.api.ScrollBoundaryDecider;
import com.example.jh.refresh_layout.constant.DimensionStatus;
...
import com.example.jh.refresh_layout.header.BezierRadarHeader;
import com.example.jh.refresh_layout.impl.RefreshContentWrapper;
import com.example.jh.refresh_layout.impl.RefreshFooterWrapper;
import com.example.jh.refresh_layout.impl.RefreshHeaderWrapper;
import com.example.jh.refresh_layout.listener.OnLoadMoreListener;
import com.example.jh.refresh_layout.listener.OnMultiPurposeListener;
import com.example.jh.refresh_layout.listener.OnRefreshListener;
import com.example.jh.refresh_layout.listener.OnRefreshLoadMoreListener;
import com.example.jh.refresh_layout.listener.OnStateChangedListener;
import com.example.jh.refresh_layout.util.DelayedRunnable;
import com.example.jh.refresh_layout.util.DensityUtil;
import com.example.jh.refresh_layout.util.ScrollBoundaryUtil;
import com.example.jh.refresh_layout.util.ViscousFluidInterpolator;
...
import static com.example.jh.refresh_layout.util.DensityUtil.dp2px;
import static com.example.jh.refresh_layout.util.SmartUtil.fling;
import static com.example.jh.refresh_layout.util.SmartUtil.getColor;
import static com.example.jh.refresh_layout.util.SmartUtil.isScrollableView;
...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    protected int mHeaderTranslationViewId;//下拉Header偏移的视图Id
    protected int mFooterTranslationViewId;//下拉Footer偏移的视图Id
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.example.jh.refresh_layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.example.jh.refresh_layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
